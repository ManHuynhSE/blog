                ...
                <div className="flex items-center justify-between text-blue-gray-900">
                    ...
                    <Link to={'/'}>
                        ...
                        >
                            ...
                            <img
                                className=' w-10 h-10 '
                                src='https://res.cloudinary.com/dmghtw364/image/upload/v1755414105/466731019_624416553481614_5916641638897030942_n_ffy7bn.jpg'
                            />
                            {/* Logo Text  */}
                            <span>
                                Blog
                            ...
                            {admin ?
                                <Link to={'/dashboard'}>
                                    <div className="">
                                        <Avatar
                                            key={1}
                                            src={'https://res.cloudinary.com/dmghtw364/image/upload/v1755414302/OIP_o5mszg.jpg'}
                                            alt="avatar"
                                            withBorder={true}
