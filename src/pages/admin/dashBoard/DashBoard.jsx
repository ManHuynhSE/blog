...
function Dashboard() {
    ...
    return (
        <Layout>
            <div className="py-10">
                <div
                    className="flex flex-wrap justify-center items-center lg:justify-center gap-2 lg:gap-10 px-4 lg:px-0 mb-8">
                    <div className="left">
                        <img
                            className=" w-40 h-40  object-cover rounded-full border-2 border-pink-600 p-1"
                            src={'https://res.cloudinary.com/dmghtw364/image/upload/v1755414302/OIP_o5mszg.jpg'} alt="profile"
                        />
                    </div>
                    <div className="right">
                        <h1
                        ...
                        <h2
                            style={{ color: mode === 'dark' ? 'white' : 'black' }} className="font-semibold">machuadu18@gmail.com
                        </h2>
                        <h2
                            style={{ color: mode === 'dark' ? 'white' : 'black' }} className="font-semibold">
